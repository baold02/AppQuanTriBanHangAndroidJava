...
public final class ActivityPhoneBinding implements ViewBinding {
  ...
  private ActivityPhoneBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView rcvPhone,
  ...
  public static ActivityPhoneBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPhoneBinding((ConstraintLayout) rootView, rcvPhone, toolbar);
    }
