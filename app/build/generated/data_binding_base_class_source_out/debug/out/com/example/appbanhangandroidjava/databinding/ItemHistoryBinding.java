...
public final class ItemHistoryBinding implements ViewBinding {
  ...
  private ItemHistoryBinding(@NonNull LinearLayout rootView, @NonNull ImageView imgHistory,
      @NonNull TextView tvNameHistory, @NonNull TextView tvNumber) {
  ...
  public static ItemHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvNameHistory;
      TextView tvNameHistory = ViewBindings.findChildViewById(rootView, id);
      if (tvNameHistory == null) {
        break missingId;
      }
      ...
      return new ItemHistoryBinding((LinearLayout) rootView, imgHistory, tvNameHistory, tvNumber);
    }
